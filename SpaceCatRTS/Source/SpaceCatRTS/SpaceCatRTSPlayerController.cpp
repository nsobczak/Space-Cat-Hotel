...
#include "SpaceCatRTSCharacter.h"
...
void ASpaceCatRTSPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("ResetVR", IE_Pressed, this, &ASpaceCatRTSPlayerController::OnResetVR);
}

void ASpaceCatRTSPlayerController::OnResetVR()
{
...
void ASpaceCatRTSPlayerController::MoveToMouseCursor()
{
	...
	{
		if (ASpaceCatRTSCharacter* MyPawn = Cast<ASpaceCatRTSCharacter>(GetPawn()))
		{
